    ...
    <section className={`${styles.welcomeCard} themeMotionCard`} data-theme-motion="card">
      ...
      <div className={styles.welcomeVisual} aria-hidden="true">
        ...
        >
          ...
          {/* connective lines drawn first so nodes sit above them */}
          ...
          <circle className={styles.haloNode} cx="160" cy="130" r="46" fill="url(#nodeGlow)" />
          ...
          {[
            ...
            <circle key={i} className={styles.satelliteNode} cx={cx} cy={cy} r="7" />
          ))}
        </svg>
